...
- Estimate $b$ and $d$ using some of the information given [here](#pheasant). State assumptions that you have made when data is lacking or information isi contradictory. Calculate $\lambda$ given the formula you derived. [4 marks]
