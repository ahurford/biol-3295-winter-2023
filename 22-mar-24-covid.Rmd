...
The selection coefficient is the slope of this regression, see [slide](https://www.zoology.ubc.ca/~otto/Talks/SSE2022_Otto.pdf) 23. The selection coefficient is $s_{XBB*} = r_{XBB*} - r_{BQ*}$, where $r_i$ is the exponential growth rate of the $i$ variant.
